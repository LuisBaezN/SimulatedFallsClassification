...
To extract the raw data from the data set an algorithm was implemented in R. This algorithm just extract two classes, and clean the data. So, tu run this example, firs run **Fall_Deep.R** to extract the data, and then, run **ann.py** to build and predict.
